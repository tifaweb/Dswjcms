...
e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": 升序",sSortDescending:": 倒序"},oPaginate:{sFirst:"第一页",sLast:"最后一页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"没有数据",sInfo:"第 _START_ 到 _END_ 条 共 _TOTAL_ 条记录",
sInfoEmpty:"空",sInfoFiltered:"(从 _MAX_ 总记录中筛选)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"显示 _MENU_ 条记录",sLoadingRecords:"加载中...",sProcessing:"处理中...",sSearch:"搜索:",sUrl:"",sZeroRecords:"没有匹配的记录"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET"};
