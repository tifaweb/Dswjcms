...
$sqls[]="DROP TABLE IF EXISTS `{$dbprefix}commision`;";
$sqls[]="CREATE TABLE IF NOT EXISTS `{$dbprefix}commision` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL,
  `catpid` varchar(50) NOT NULL,
  `name` varchar(40) NOT NULL,
  `level` tinyint(4) NOT NULL,
  `ratio` varchar(5) NOT NULL,
  `bonus` float(4,2) NOT NULL,
  `status` tinyint(1) NOT NULL,
  `if_downNode` tinyint(1) NOT NULL,
...
$sqls[]="DROP TABLE IF EXISTS `{$dbprefix}forrecord`;";
$sqls[]="CREATE TABLE IF NOT EXISTS `{$dbprefix}forrecord` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `gid` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
  `indent` varchar(20) NOT NULL,
  `type` tinyint(1) NOT NULL,
...
$sqls[]="DROP TABLE IF EXISTS `{$dbprefix}integral`;";
$sqls[]="CREATE TABLE IF NOT EXISTS `{$dbprefix}integral` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `number` int(7) unsigned NOT NULL DEFAULT '0',
  `convert` int(7) unsigned NOT NULL DEFAULT '0',
...
(2, 1, 'vip_buy', '30', '会员成为VIP获得的积分'),
(3, 2, 'pro_registered', '10', '推荐会员注册后获得的积分'),
(5, 0, 'mem_tender', '20', '投标获取20积分'),
(6, 1, 'vip_tender', '20', '投标获得20VIP积分'),
(7, 2, 'pro_tender', '5', '获取5点推广积分'),
(8, 0, 'mem_assure', '20', '担保获取20积分'),
(9, 1, 'vip_assure ', '20', '会员担保获取VIP积分'),
(10, 2, 'pro_assure', '5', '担保获取5点推广积分'),
(11, 0, 'mem_flow', '20', '认购获取20积分'),
(12, 1, 'vip_flow', '20', '认购获取VIP积分'),
(13, 2, 'pro_flow', '5', '认购获取5点推广积分'),
(14, 0, 'mem_other', '10', '其实操作添加积分'),
(15, 1, 'vip_other', '10', '其实操作添加VIP积分'),
(16, 2, 'pro_other', '5', '其实操作添加推广积分'),
(17, 0, 'mem_certification', '10', '用户通过实名认证获得的积分 '),
(18, 2, 'pro_certification ', '5', '推荐会员通过实名认证获得的积分'),
(19, 0, 'mem_email_audit', '10', '用户通过邮箱认证获得的积分'),
(20, 0, 'mem_cellphone_audit', '10', '用户通过手机认证获得的积分'),
(21, 0, 'mem_video_audit', '10', '用户通过视频认证获得的积分'),
(22, 0, 'mem_site_audit', '10', '会员通过现场认证获得的积分'),
(23, 2, 'pro_email_audit', '5', '推荐会员通过邮箱认证获得的积分 '),
(24, 2, 'pro_cellphone_audit', '5', '推荐会员通过手机认证获得的积分 '),
(25, 2, 'pro_video_audit', '5', '推荐会员通过视频认证获得的积分 '),
(26, 2, 'pro_site_audit', '5', '推荐会员通过现场认证获得的积分 ');";	
...
$sqls[]="DROP TABLE IF EXISTS `{$dbprefix}promote_integral`;";
$sqls[]="CREATE TABLE IF NOT EXISTS `{$dbprefix}promote_integral` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
$sqls[]="INSERT INTO `{$dbprefix}shuffling` (`id`, `title`, `type`, `state`, `time`, `img`, `order`) VALUES
(2, '2', 0, 0, '1383399157', '1383697312.2143.jpg', 0),
(7, '1', 0, 0, '1384258731', '1385446738.0336.jpg', 0),
(8, '3', 0, 0, '1386331886', '1386333369.8302.jpg', 0);";
...
(6, NULL, 'article', '1384743848', NULL, NULL, ''),
(7, NULL, 'article', '1384743883', NULL, NULL, ''),
(8, NULL, 'article', '1384743990', NULL, NULL, ''),
(9, NULL, 'article', '1384744024', NULL, NULL, ''),
(10, NULL, 'article', '1384744050', NULL, NULL, ''),
(11, NULL, 'article', '1384744075', NULL, NULL, ''),
(12, NULL, 'article', '1384744097', NULL, NULL, ''),
...
(8, '手机', '请输入手机号', '13088888888', 'sys_cellphone', 1),
(6, '地址', '请输入地址', '上海市嘉定区华亭镇', 'sys_address', 1),
(7, '邮箱', '请输入邮箱', 'pang453758463@163.com', 'sys_email', 1),
...
(14, 'VIP利息管理费', '请输入VIP利息管理费', '0.001', 'sys_vipInterestMF', 1),
(15, '提现手续费免费额度', '请输入额度', '100', 'sys_wFPoundage', 1),
(16, '提现手续费率', '请输入提现手续费', '0.001', 'sys_withdrawalPoundage', 1),
(17, '微信登陆账户', '请输入账户', 'dianshiweijin@126.com', 'sys_weiAccount', 1),
(18, '微信登陆密码', '请输入登陆密码', 'pang453758463', 'sys_weiPassword', 1),
...
(22, '数据自动备份间隔时间', '请输入间隔时间以秒计算', '3600', 'sys_backuptime', 1),
(23, 'VIP月费用', '请输入VIP每月扣除费用', '20', 'sys_vipm', 1),
(24, 'VIP年费用', '请输入VIP每年扣除费用', '200', 'sys_vipy', 1),
(25, '逾期30天内的利率', '请输入逾期30天内的利率', '0.001', 'sys_overdue', 1),
(26, '逾期30天后的利率', '请输入逾期30天后的利率', '0.005', 'sys_overdues', 1),
(27, '还款到期提前提醒天数', '请输入还款到期提前提醒天数', '5', 'sys_refundDue', 1),
(28, '自动投标功能开(1)/关(0)', '请输入1或0', '0', 'sys_automaticBid', 1),
(29, '自动投标秒标是否可投开(1)/关(0)', '请输入1或0', '0', 'sys_secAutomaticBid', 1),
(30, '自动投标占比例(百分比)', '请数据1到100之间的值', '60', 'sys_autoscale', 1),
(31, '公司', '请输入公司名', '宁波天发网络', 'sys_company', 1),
(32, '净值比例（占待收资金的百分比）', '请0到100范围内的数值', '20', 'sys_net', 1),
(33, '信用标积分要求', '请输入数值', '20', 'sys_credit', 1),
(34, '视频认证费用', '请输入金额', '20', 'sys_video', 1),
(35, '现场认证费用', '请输入金额', '100', 'sys_site', 1),
(36, '协议书编号', '请输入协议书码号', 'NB-TF', 'sys_agreement', 1),
(37, '公司所在地', '请输入办公地址', '宁波市鄞州区中首南街道宁波商会B605', 'sys_officeAddress', 1),
(38, '提前还款利率', '请输入利率', '0.005', 'sys_advanceRate', 1),
...
$sqls[]="DROP TABLE IF EXISTS `{$dbprefix}user_commision`;";
$sqls[]="CREATE TABLE IF NOT EXISTS `{$dbprefix}user_commision` (
  `uid` int(11) NOT NULL,
...
$sqls[]="DROP TABLE IF EXISTS `{$dbprefix}vip_points`;";
$sqls[]="CREATE TABLE IF NOT EXISTS `{$dbprefix}vip_points` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `total` int(11) unsigned NOT NULL,
  `available` int(11) unsigned NOT NULL,
