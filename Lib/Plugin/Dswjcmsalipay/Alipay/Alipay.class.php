...
class Alipay extends Basis {
	...
	public function install(){
		...
		$arr['name']='Alipay';		//插件名称
		$arr['title']='支付宝标准又接口';		//插件中文名
		$arr['describe']='支付宝标准双接口接口';	//插件描述
		$arr['instructions']='Alipay';	//安装说明
		$arr['data']=array(		//配置参数
	...
	public function delete(){
		$this->DsdeleteFile('info.txt',$this->pluginname);	//删除代码
	}
